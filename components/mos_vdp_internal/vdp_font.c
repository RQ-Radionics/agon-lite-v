/*
 * vdp_font.c — Agon BBC Micro 8x8 font bitmap
 *
 * Extracted from agon-vdp/video/agon_fonts.h
 * Original authors: Damien Guard, Lennart Benschop
 * License: zlib (see agon-vdp/video/agon_fonts.h)
 *
 * 224 characters starting at ASCII 0x20 (space).
 * Each character is 8 bytes, 1 byte per row, MSB = leftmost pixel.
 */

#include "vdp_font.h"

/* 224 characters x 8 bytes, starting at ASCII 0x20 (space) */
const uint8_t vdp_font_8x8[224 * 8] = {
