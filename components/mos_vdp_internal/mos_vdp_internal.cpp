...
/* Screen geometry                                                      */
/* ------------------------------------------------------------------ */
#define FB_W            CONFIG_MOS_VDP_INTERNAL_FB_WIDTH   /* physical framebuffer width  = HDMI hact */
#define FB_H            CONFIG_MOS_VDP_INTERNAL_FB_HEIGHT  /* physical framebuffer height = HDMI vact */
#define FONT_W          8
#define FONT_H          8
#define BYTES_PER_PIX   3                     /* RGB888 */
#define FB_SIZE         (FB_W * FB_H * BYTES_PER_PIX)
