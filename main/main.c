...
static esp_lcd_panel_handle_t hdmi_init(void)
{
     ...
     *    1280x720 @ 64 MHz pixel clock, RGB888 (24-bit).
     *    Olimex BSP production-test validated timings (1280x720@60Hz):
     *      htotal=1440 (hfp=48 hs=32 hbp=80), vtotal=741 (vfp=3 vs=5 vbp=13)
    ...
    esp_lcd_dpi_panel_config_t dpi_cfg = {
        ...
        .dpi_clock_freq_mhz  = 64,          /* 64 MHz for 1280x720@60Hz (Olimex production test) */
    ...
    ESP_LOGI(TAG, "HDMI: step 5 — clear framebuffers + panel enable");
    {
        ...
        if (esp_lcd_dpi_panel_get_frame_buffer(panel, 2, &fb0, &fb1) == ESP_OK) {
            size_t fb_size = 1280 * 720 * 3;  /* RGB888 */
    ...
    ESP_LOGI(TAG, "HDMI: 1280x720@60Hz ready%s",
